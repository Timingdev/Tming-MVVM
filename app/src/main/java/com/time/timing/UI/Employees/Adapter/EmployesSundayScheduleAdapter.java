...
public class EmployesSundayScheduleAdapter extends RecyclerView.Adapter<ShiftRequestViewHolder> {

    @Setter @Getter
    private List<EmployeesSundayScheduleModel> list;
    ...
    public void setdata(EmployeesSundayScheduleModel model, List<EmployeesSundayScheduleModel> list, ShiftRequestViewHolder holder) {
