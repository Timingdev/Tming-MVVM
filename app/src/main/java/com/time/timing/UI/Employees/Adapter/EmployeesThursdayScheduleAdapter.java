...
public class EmployeesThursdayScheduleAdapter extends RecyclerView.Adapter<ShiftRequestViewHolder>{
    @Setter @Getter
    private List<EmployeesThusdayScheduleModel> list;
    ...
    public void onBindViewHolder(@NonNull ShiftRequestViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.ProgressID.setMax(Integer.valueOf(list.get(position).getNumber_of_workers_for_this_shift()));
        ...
        MyScheduleRef.document(list.get(position).getUID()).collection(list.get(position).getData()).document(list.get(position).getShiftName()).addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if(value.exists()){
                    String RegistationUsers = value.getString(DataManager.RegistrationUsers);
                    String TotalRegistationUser = list.get(position).getNumber_of_workers_for_this_shift();
    ...
    public void setdata(EmployeesThusdayScheduleModel model, List<EmployeesThusdayScheduleModel> list, ShiftRequestViewHolder holder) {
