...
public class SaturdayShiftRequestAdapter extends RecyclerView.Adapter<ShiftRequestVH> {
    @Setter @Getter
    ...
    public interface OnClick{
        void Click(SaturdaySchaduleModel saturdaySchaduleModel,String UID, String Date, String Type, boolean RequestForAdditionalHour, String ShiftName);
    }
