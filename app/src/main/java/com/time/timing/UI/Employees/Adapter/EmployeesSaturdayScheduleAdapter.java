...
public class EmployeesSaturdayScheduleAdapter extends RecyclerView.Adapter<ShiftRequestViewHolder> {

    @Getter @Setter
    private List<EmployeesSaturdayScheduleModel> list;
    ...
    public void setdata(EmployeesSaturdayScheduleModel model, List<EmployeesSaturdayScheduleModel> list, ShiftRequestViewHolder holder) {
