...
import com.time.timing.databinding.SelectweakBinding;
...
public class SelectWeak extends AppCompatActivity {

    private SelectweakBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.selectweak);
    ...
    private void InitView() {
        binding.EditDays.setOnClickListener(view -> {
            HandleActivity.GotoEditWeek(SelectWeak.this);
        });
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            for (int i = 0; i < getDaysOfWeek().length; i++) {
                ...
                adapter.OnClickEvent(SelectDate -> {
                    HandleActivity.GotoSelectShift(SelectWeak.this, SelectDate);
                });
            }
