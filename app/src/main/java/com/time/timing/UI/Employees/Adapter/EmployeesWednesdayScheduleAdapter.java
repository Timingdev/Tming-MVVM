...
public class EmployeesWednesdayScheduleAdapter extends RecyclerView.Adapter<ShiftRequestViewHolder>{
    @Setter @Getter
    private List<EmployeesWednesdayScheduleModel> list;
    ...
    @Override
    public void onBindViewHolder(@NonNull ShiftRequestViewHolder holder, int position) {
    ...
    public void setdata(EmployeesWednesdayScheduleModel model, List<EmployeesWednesdayScheduleModel> list, ShiftRequestViewHolder holder) {
