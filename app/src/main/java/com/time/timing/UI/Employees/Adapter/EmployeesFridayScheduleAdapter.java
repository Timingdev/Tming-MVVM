...
public class EmployeesFridayScheduleAdapter extends RecyclerView.Adapter<ShiftRequestViewHolder>{
    @Setter @Getter
    private List<EmployeesFridayScheduleModel> list;
    ...
    public void setdata(EmployeesFridayScheduleModel model, List<EmployeesFridayScheduleModel> list, ShiftRequestViewHolder holder) {
