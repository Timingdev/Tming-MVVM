...
public class WednessdayShiftRequestAdapter extends RecyclerView.Adapter<ShiftRequestVH> {
    @Setter @Getter
    ...
    public interface OnClick{
        void Click(WednesdaySchaduleModel wednesdaySchaduleModel, String UID, String Date, String Type, boolean RequestForAdditionalHour, String ShiftName);
    }
