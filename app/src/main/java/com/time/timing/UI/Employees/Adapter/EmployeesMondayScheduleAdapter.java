...
public class EmployeesMondayScheduleAdapter extends RecyclerView.Adapter<ShiftRequestViewHolder>{
    @Setter @Getter
    private List<EmployeesMondayScheduleModel> list;
    ...
    public void setdata(EmployeesMondayScheduleModel model, List<EmployeesMondayScheduleModel> list, ShiftRequestViewHolder holder) {
