...
public class SundayShiftRequestAdapter extends RecyclerView.Adapter<ShiftRequestVH> {
    ...
    public interface OnClick{
        void Click(SundayScheduleModel SundayScheduleModel, String UID, String Date, String Type, boolean RequestForAdditionalHour, String ShiftName);
    }
