...
public class SaturdayScheduleGET {
    ...
    public SaturdayScheduleGET(Application application){
    ...
    public LiveData<List<SaturdaySchaduleModel>> GetSaturdaySchedule(String dayName){
