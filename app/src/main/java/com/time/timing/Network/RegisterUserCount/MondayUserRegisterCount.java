...
public class MondayUserRegisterCount {
    ...
    public MondayUserRegisterCount(Application application) {
        this.application = application;
        MyScheduleRef = FirebaseFirestore.getInstance().collection(DataManager.MySchedule);
        Mauth = FirebaseAuth.getInstance();
    }

    public LiveData<Integer> GetMyScheduleMondayUserCount(String UID, String Date) {
