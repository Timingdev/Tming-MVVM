...
public class FridayScheduleRequestGET {
    ...
    public FridayScheduleRequestGET(Application application) {
        this.application = application;
        Mauth = FirebaseAuth.getInstance();
        RequestForShiftRef = FirebaseFirestore.getInstance().collection(DataManager.RequestForShift);
    }

    public LiveData<List<FridaySchaduleModel>> GetFridayRequest(String PhoneNumber, String Date) {
