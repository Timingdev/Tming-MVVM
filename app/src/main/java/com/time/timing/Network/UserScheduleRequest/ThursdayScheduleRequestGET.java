...
public class ThursdayScheduleRequestGET {
    ...
    public ThursdayScheduleRequestGET(Application application) {
        this.application = application;
        Mauth = FirebaseAuth.getInstance();
        RequestForShiftRef = FirebaseFirestore.getInstance().collection(DataManager.RequestForShift);
    }

    public LiveData<List<ThursdaySchaduleModel>> GetThursdayRequest(String PhoneNumber, String Date) {
