...
public class PreviousScheduleSundayGET {
    ...
    public PreviousScheduleSundayGET(Application application){
    ...
    public LiveData<List<SundayScheduleModel>> GetPreviousSundayScheduleData(String Date){
        ...
        if(FirebaseUser != null){
            executor.execute(new Runnable() {
                @Override
                public void run() {
                    MyScheduleRef.document(FirebaseUser.getUid()).collection(Date).addSnapshotListener(new EventListener<QuerySnapshot>() {
                        @Override
