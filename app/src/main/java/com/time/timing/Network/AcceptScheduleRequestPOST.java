...
public class AcceptScheduleRequestPOST {
    ...
    public AcceptScheduleRequestPOST(Application application){
    ...
    public LiveData<Boolean> AcceptScheduleRequest(String ReceiverUID, String Date, String Schedule, boolean IsAdditionHoursNeed, String Type, String ShiftNo){
            ...
            UserRef.document(FirebaseUser.getUid()).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                ...
                public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                    ...
                    if(value.exists()){
                        ...
                        map.put(DataManager.Date, Date);
                        map.put(DataManager.ShifName, ShiftNo);
                                            ...
                                            MySchedule.document(ReceiverUID).collection(Date).document(Schedule).collection(DataManager.Users).addSnapshotListener(new EventListener<QuerySnapshot>() {
                                                ...
                                                public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                                    ...
                                                    if(!value.isEmpty()){
                                                        ...
                                                        MySchedule.document(ReceiverUID).collection(Date).document(Schedule).update(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if(task.isSuccessful()){
                                                                    data.setValue(true);
