...
public class EmployeesSundayScheduleGET {
    ...
    public EmployeesSundayScheduleGET(Application application){
        this.application = application;
        Mauth = FirebaseAuth.getInstance();
        ScheduleRequestRef = FirebaseFirestore.getInstance().collection(DataManager.ScheduleRequest);
    }

    public LiveData<List<EmployeesSundayScheduleModel>> GetRequestSundayEmployeesSchedule(String Number, String Date){
