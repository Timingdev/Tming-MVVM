...
public class MondayScheduleGET {
    ...
    public MondayScheduleGET(Application application){
    ...
    public LiveData<List<MondaySchaduleModel>> GetMondaySchedule(String dayName){
