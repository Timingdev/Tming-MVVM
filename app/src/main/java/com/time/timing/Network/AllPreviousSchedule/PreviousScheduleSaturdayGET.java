...
public class PreviousScheduleSaturdayGET {
    ...
    public PreviousScheduleSaturdayGET(Application application){
    ...
    public LiveData<List<SaturdaySchaduleModel>> GetPreviousSaturdayScheduleData(String Date){
