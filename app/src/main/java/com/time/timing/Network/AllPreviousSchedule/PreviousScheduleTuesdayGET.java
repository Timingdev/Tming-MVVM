...
public class PreviousScheduleTuesdayGET {
    ...
    public PreviousScheduleTuesdayGET(Application application){
    ...
    public LiveData<List<TuesdaySchaduleModel>> GetPreviousTuesdayScheduleData(String Date){
