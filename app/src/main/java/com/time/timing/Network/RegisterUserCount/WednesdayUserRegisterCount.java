...
public class WednesdayUserRegisterCount {
    ...
    public WednesdayUserRegisterCount(Application application){
        this.application = application;
        MyScheduleRef = FirebaseFirestore.getInstance().collection(DataManager.MySchedule);
        Mauth = FirebaseAuth.getInstance();
    }

    public LiveData<Integer> GetMyScheduleWednesdayUserCount(String UID, String Date){
