...
public class TuesdayScheduleGET {
    ...
    public TuesdayScheduleGET(Application application){
    ...
    public LiveData<List<TuesdaySchaduleModel>> GetThesdaySchedule(String dayName){
