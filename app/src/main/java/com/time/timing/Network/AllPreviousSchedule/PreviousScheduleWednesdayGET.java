...
public class PreviousScheduleWednesdayGET {
    ...
    public PreviousScheduleWednesdayGET(Application application){
    ...
    public LiveData<List<WednesdaySchaduleModel>> GetPreviousWednesdayScheduleData(String Date){
