...
public class SaturdayUserRegisterCount {
    ...
    public SaturdayUserRegisterCount(Application application) {
        this.application = application;
        MyScheduleRef = FirebaseFirestore.getInstance().collection(DataManager.MySchedule);
        Mauth = FirebaseAuth.getInstance();
    }

    public LiveData<Integer> GetMyScheduleSaturdayUserCount(String UID, String Date) {
